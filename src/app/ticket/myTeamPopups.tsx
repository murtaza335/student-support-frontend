    ...
    <>
      <Dialog open={open} onClose={() => setOpen(false)} className="relative z-50">
        ...
        <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4">
          <Dialog.Panel className={`w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] bg-white rounded-xl sm:rounded-2xl shadow-2xl border border-slate-200/60 transform transition-all duration-300 overflow-hidden flex flex-col ${
    ...
    <>
      ...
      <div className="px-4 sm:px-6 py-4 sm:py-5 flex-1 overflow-hidden min-h-0">
        {isLoading ? (
          ...
          <div className="space-y-2 sm:space-y-3 max-h-64 sm:max-h-96 overflow-y-auto custom-scrollbar pr-2">
...
function ReplaceAssignmentSection({
  ...
  return (
    <div className="px-4 sm:px-6 py-4 sm:py-5 space-y-6 max-h-96 overflow-y-auto custom-scrollbar">
